                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <div class="image-input image-input-outline"
                                         ...
                                         style="background-image: url('{{ asset('storage/' . auth()->user()->avatar) ?? asset('assets/backend/themes/media/users/blank.png') }}')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <div class="input-group input-group-lg ">
                                        ...
                                        <input type="text" class="form-control form-control-lg" readonly
                                               value="{{auth()->user()->balance}}" placeholder="{{__('Số dư')}}"/>
                                    </div>
                                </div>
                            </div>
                            <!--end::Group-->
